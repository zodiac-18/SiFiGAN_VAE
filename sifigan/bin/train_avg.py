...
def main(config: DictConfig) -> None:
    ...
    if config.train.resume:
        resume = os.path.join(out_dir, "checkpoints", f"checkpoint-{config.train.resume}steps.pkl")
    ...
    try:
        ...
        trainer.save_checkpoint(
            os.path.join(out_dir, "checkpoints", f"checkpoint-{trainer.steps}steps.pkl")
        )
